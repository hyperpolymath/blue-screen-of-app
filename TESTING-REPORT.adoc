...
* `/var$HOME/repos/blue-screen-of-app/tests/unit/analytics.test.js`
* `/var$HOME/repos/blue-screen-of-app/tests/unit/errorMessages.test.js`
* `/var$HOME/repos/blue-screen-of-app/tests/integration/api.test.js`
* `/var$HOME/repos/blue-screen-of-app/tests/integration/bsod.test.js`
...
* `/var$HOME/repos/blue-screen-of-app/src/server.js`
...
* `/var$HOME/repos/blue-screen-of-app/.tool-versions`
...
1. **Add SPDX headers to source files**: The AffineScript-generated `.bs.js` files lack SPDX license headers. Consider adding them during build or using a post-processing script.
...
1. **AffineScript source files**: The project references AffineScript but `.res` source files are missing. Either add the AffineScript sources or document that the `.bs.js` files are the primary sources.
